...
extern void test_call(int a, int b, int c) __attribute__((__cdecl__));
...
struct vm_operations_struct simple_nopage_vm_ops = {
	.open =   simple_vma_open,
	.close =  simple_vma_close,
 ...
 */
void simple_setup_cdev(struct cdev *dev, int minor,
